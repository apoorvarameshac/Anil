...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">MATCH Location </label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Total cost</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">SEAT TYPE</label>
									<div class="col-sm-8">
